...
<head>
	...
	<title><?php echo $page_title; ?> :: Peixes da Serra do Cipó - MG</title>
...
<div class="container-fluid" role="main">
    <div class="row my-2 p-2">
        ...
        <div class="col-12 col-md-2">
            <a href="user_user.php?id=0" class="btn btn-primary float-right" role="button">New</a>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class=" my-3 p-3 bg-white rounded box-shadow">
                <table class="table table-striped table-hover table-sm">
                    <tr width="100%">
                        <th width="5%"><a href="user_users.php?order_by=id">ID</a></th>
                        <th width="55%"><a href="user_users.php?order_by=name">Name</a></th>
                        <th width="35%"><a href="user_users.php?order_by=type">Type</a></th>
                        <th width="5%" colspan="2">State</th>
                    </tr>
                    <?php
                    $sql = 'SELECT uu.id AS id, CONCAT(uu.first_name, " ", uu.last_name) AS name, uu.id_type AS type, uu.published AS published
                    ...
                    if($result=mysqli_query($mysqli,$sql))
                    {
                        if($result->num_rows)
                        {
                            ...
                            while($row = mysqli_fetch_assoc($result))
                            {
                                ...
                                echo '<tr>';
                                echo '<td>'.$row['id'].'</td>';
                                echo '<td><a href="user_user.php?id='.$row['id'].'">'.$row['name'].'</a></td>';
                                echo '<td>'.$row['type'].'</td>';
