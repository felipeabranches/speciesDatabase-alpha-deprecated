...
if (isset($_POST['save']))
{
    ...
    else
    {
        if ($id == 0)
        {
            $sql = "INSERT INTO users_users (name, username, email, password) 
            ...
            header ("Location: users_users.php"); //header("refresh:3;url=users_users.php");
        }
        else
        {
    ...
    <form action="" method="post">
        ...
        <div class="toolbar sticky-top row my-2 p-2">
            ...
            <div class="col-12 col-md-2 text-right">
                ...
                <a href="users_users.php?order_by=id" class="btn btn-outline-danger" role="button">Cancel</a>
            </div>
        </div>
        <div class="row">
            <div class="col-12 col-md-8">
                <div class="my-3 p-3 bg-white rounded box-shadow">
                    <?php field_text ('Name', 'name', $name, 'Enter the User first name', 'required'); ?>
                    <?php field_text ('Username', 'username', $username, 'Enter the User last name', 'required'); ?>
