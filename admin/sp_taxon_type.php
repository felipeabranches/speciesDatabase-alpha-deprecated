...
if (isset($_POST['save']))
{
    ...
    else
    {
        if ($id == 0)
        {
            $sql = "INSERT INTO sp_taxa_types (name, description, note, image, published) 
            ...
            header ("Location: sp_taxa_types.php"); //header("refresh:3;url=sp_taxon_type.php");
        }
        else
        {
        ...
        <div class="row">
            <div class="col-12 col-md-8">
                <div class="my-3 p-3 bg-white rounded box-shadow">
                    <?php field_text ('Name', 'name', $name, 'Enter the Taxon Type name', 'required'); ?>
                </div>
                <div class="my-3 p-3 bg-white rounded box-shadow">
            ...
            <div class="col-12 col-md-4">
                <div class="my-3 p-3 bg-white rounded box-shadow">
                    <h5>State</h5>
                    <?php field_toggle ('Published', 'published', array(1 => 'yes', 0 => 'no'), 'sp_taxa_types', $id, 1, 'yesno'); ?>
