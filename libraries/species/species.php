...
function getTaxonomists() {
            global $mysqli;
               $sql = 'SELECT
                    ...
                    FROM sp_taxonomists_map AS sptx
              ...
              $result_check = mysqli_num_rows($result);
                ...
                if ($result_check > 0 ) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        $revised = $row['revised'];   $year = $row['year']; 
...
$teste = new Species(); // TESTANDO OBJETO DA CLASSE
$teste->getNomenclature();   //TESTANDO A FUNCAO DA CLASSE
$teste2 = new Species();
